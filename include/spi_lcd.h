...
#define LCD_SPI3_DEF_PIN_NUM_CS0  26  // SPI3默认的CS0引脚

#define PIN_NUM_DC   25    // D/C线，0-命令，1-数据
#define PIN_NUM_RST  27    // RST复位引脚。-1为空置不使用。但LCD的RST引脚应上拉接高电平。
#define PIN_NUM_BCKL 4    // 背光BLK引脚。0-关闭，1-打开
...
#define LCD_DEF_DMA_CHAN         1   // LCD默认使用的SPI-DMA通道
